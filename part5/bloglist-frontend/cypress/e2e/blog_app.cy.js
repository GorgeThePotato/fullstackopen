describe('Blog', function() {
  ...
  describe('when logged in', function() {
    ...
    it('a blog can be liked', function(){
      cy.createBlog({title:'blog created by cypress', author:'cypress',url:'cypress.com'})
      cy.get('.blog')
        .contains('view')
        .click()
      cy.get('.blog_details')
    ...
    it('blogs are ordered based on likes', function(){
      cy.createBlog({title:'blog with 0 likes', author:'cypress',url:'cypress.com'})
      cy.createBlog({title:'blog with 4 likes', author:'cypress',url:'cypress.com'})
      cy.createBlog({title:'blog with 2 likes', author:'cypress',url:'cypress.com'})
